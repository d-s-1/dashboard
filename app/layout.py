...
app.layout = html.Div(id='app_container', style={'minHeight':'100%', 'maxHeight':'100%', 'minWidth':'25%', 'maxWidth':'100%', 'display':'flex', 'flexDirection':'row', 'alignItems':'flex-start', 'padding':'0 1rem'},
                      children=[
                          html.Div(id='menu_section', style={'minHeight':'100%', 'maxHeight':'100%', 'minWidth':'25%', 'maxWidth':'25%', 'display':'flex', 'flexDirection':'column', 'alignItems':'flex-start', 'padding':'0 1rem'},
                                   children=[
                                                ...
                                                children=[
                                                    ...
                                                    html.Div(id='rank_by_section', style={'minWidth':'100%', 'maxWidth':'100%', 'display': 'flex', 'flexDirection': 'row', 'alignItems': 'flex-start', 'padding': '0 1rem'},
                                                             children=[
                                                                 ...
                                                                 dcc.Dropdown(id='rank_by_dropdown', options=[{'label':result, 'value':result} for result in ('Avg Charged', 'Patient')], value='Avg Charged', style={'minWidth':'12.5rem'}, clearable=False)
                                                             ]
                                                             ),
                                                    ...
                                                    html.Div(id='hcpcs_description_checkbox_section', style={'minWidth': '100%', 'maxWidth': '100%', 'display': 'flex', 'flexDirection': 'row', 'alignItems': 'flex-start', 'padding': '0 1rem'},
                                                             children=[
                                                                 html.P(id='hcpcs_description_checkbox_label', style={'width': '16rem', 'font-size':'1.2rem', 'font-style':'italic'}, children=['Display HCPCS Descriptions']),
                                                                 dcc.Checklist(id='hcpcs_description_checkbox', options=[{'label': '', 'value': 'yes'}])
                                                             ]
                                                             ),
                                                    dcc.Textarea(id='hcpcs_description_textbox', hidden=True, readOnly=True, style={'minHeight':'30rem', 'maxHeight':'30rem', 'minWidth':'100%', 'maxWidth':'100%', 'padding': '0 1.2rem'}),
                                                ]
                                                ),
                                       html.Div(id='button_section', style={'minWidth':'100%', 'maxWidth':'100%', 'display':'flex', 'flexDirection':'row', 'alignItems':'flex-start', 'padding':'3rem 1rem'},
                                                children=[
                                                    ...
                                                    html.Button(id='export_button', type='button', children=['Export'])
                                                ]
                                                )
                                   ]
                                   ),
                                                    ...
                                                    html.Div(id='ten_table_section',
                                                             ...
                                                             children=[
                                                                 dt.DataTable(id='ten_table', columns=[{'id': x, 'name': y} for x, y in (('provider_id', 'Provider ID'),('patients', 'Patients'),('avg_charged', 'Avg Charged'),('avg_allowed', 'Avg Allowed'),('avg_paid', 'Avg Paid'))],
                                                                              ...
                                                                              style_as_list_view=True, style_data_conditional=[{'if': {'row_index': 'odd'},'backgroundColor': 'rgb(248, 248, 248)'}])
                                                             ]
                                                             ),
